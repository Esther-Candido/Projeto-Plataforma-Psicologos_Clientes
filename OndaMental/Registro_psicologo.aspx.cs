...
{
    public partial class Registro_psicologo : System.Web.UI.Page
    {
        ...
        protected void tb_registrar_Click(object sender, EventArgs e)
        {
            //pwConfirm() == false ||
        ...
        public void sqlregister()
        {
            ...
            myCommand.Parameters.AddWithValue("@cod_perfil", 2);
            ...
            myCommand.CommandText = "inserir_psicologo";
        ...
        public void confirmMail()
        {
            ...
            mail.Subject = $"Registro de Psicólogo - Ativaçao de conta";
        ...
        {
            // Construa a URL de redirecionamento para a autenticação do Google
            string clientId = "441142679551-7ruv3hb8qmcv3gghqnkmhgcm2ipqilvq.apps.googleusercontent.com";
            string redirectUri = "https://localhost:44337/signing-google.aspx"; // Certifique-se de que esta URL coincide com a configurada no Console de Desenvolvedor do Google
            string googleAuthUrl = $"https://accounts.google.com/o/oauth2/auth?client_id={clientId}&redirect_uri={redirectUri}&response_type=code&scope=openid%20profile%20email";
