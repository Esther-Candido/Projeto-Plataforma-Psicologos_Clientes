...
{
    public partial class alterar_pw2 : System.Web.UI.Page
    {
        ...
        protected void tb_alterar_pw_Click(object sender, EventArgs e)
        {
            ...
            if (tb_pw_atual.Text == tb_pw_nova.Text)
            {
                lbl_senharepetida.Text = "Nao pode repetir a password antiga com a nova\n";
                forte = false;
            }
            ...
            SqlConnection myConn = new SqlConnection(ConfigurationManager.ConnectionStrings
               ["SiteOndaMentalConnectionString"].ConnectionString);
            ...
            if (forte)
            {
                ...
                myCommand.Parameters.AddWithValue("@email", Session["utilizador"].ToString());  //foi passada uma variavel apos o login de Session["utilizador"] = tb_email.Text; ou seja é o email do utilizador que fez o login
                myCommand.Parameters.AddWithValue("@pw_antiga", EncryptString(tb_pw_atual.Text));
                ...
                myCommand.CommandText = "alterar_pw2";
