<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Registro_psicologo.aspx.cs" Inherits="OndaMental.Registro_psicologo" %>
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Crie Conta de Psicologo</h2>
              ...
              <div>
                ...
                <div class="form-outline mb-4">
                    <label class="form-label" for="form3Example1cg">Nº Carteira Profissional</label>
                 <asp:TextBox ID="tb_cp" runat="server" class="form-control form-control-lg"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Carteira profissional é obrigatório" ControlToValidate="tb_cp"></asp:RequiredFieldValidator>
                </div>
                ...
                <div class="form-outline mb-4">
                  ...
                  <asp:TextBox ID="tb_email" runat="server" class="form-control form-control-lg"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="E-mail é obrigatório" ControlToValidate="tb_email"></asp:RequiredFieldValidator>
                </div>
                ...
                <div class="form-outline mb-4">
                  ...
                  <asp:TextBox ID="tb_pw" type="password" runat="server" class="form-control form-control-lg"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Palavra-Passe é obrigatório" ControlToValidate="tb_pw"></asp:RequiredFieldValidator>
                </div>
                ...
                <asp:Button ID="tb_registrar" runat="server" Text="Registrar" class="btn btn-success" OnClick="tb_registrar_Click"/>
                </div>
